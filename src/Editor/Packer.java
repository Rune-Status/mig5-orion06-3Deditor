...
public class Packer extends FilterOutputStream implements DataOutput {
	...
	//public static void writeString(Packer dos, String toWrite) {
	...
	public void writeSignedByte(int oneByte) throws IOException {
		out.write(oneByte);
		written++;
	}
	
	public void writeUnsignedByte(int oneByte) throws IOException {
	...
	int writeUTFBytesToBuffer(String str, long count, byte[] buffer, int offset) throws IOException {
